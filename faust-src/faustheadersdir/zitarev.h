/* ------------------------------------------------------------
name: "zitarev"
Code generated with Faust 2.36.1 (https://faust.grame.fr)
...
class zitarev : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a faust2header.cpp -lang cpp -inpl -es 1 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow21 = ((std::exp((fConst5 / fSlow20)) / fSlow11) + -1.0f);
		float fSlow22 = (1.0f / std::tan((fConst6 * float(fVslider9))));
		...
		float fSlow34 = ((std::exp((fConst12 / fSlow20)) / fSlow26) + -1.0f);
		...
		float fSlow43 = ((std::exp((fConst17 / fSlow20)) / fSlow35) + -1.0f);
		...
		float fSlow52 = ((std::exp((fConst22 / fSlow20)) / fSlow44) + -1.0f);
		...
		float fSlow61 = ((std::exp((fConst27 / fSlow20)) / fSlow53) + -1.0f);
		...
		float fSlow70 = ((std::exp((fConst32 / fSlow20)) / fSlow62) + -1.0f);
		...
		float fSlow79 = ((std::exp((fConst37 / fSlow20)) / fSlow71) + -1.0f);
		...
		float fSlow88 = ((std::exp((fConst42 / fSlow20)) / fSlow80) + -1.0f);
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp3 = (((0.600000024f * fRec12[1]) + fVec2[((IOTA - iConst8) & 32767)]) - fTemp2);
			fVec3[(IOTA & 2047)] = fTemp3;
			fRec12[0] = fVec3[((IOTA - iConst10) & 2047)];
			...
			float fTemp4 = (((0.600000024f * fRec16[1]) + fVec4[((IOTA - iConst14) & 32767)]) - fTemp2);
			fVec5[(IOTA & 4095)] = fTemp4;
			fRec16[0] = fVec5[((IOTA - iConst15) & 4095)];
			...
			float fTemp5 = (fVec6[((IOTA - iConst19) & 16383)] + (fTemp2 + (0.600000024f * fRec20[1])));
			fVec7[(IOTA & 4095)] = fTemp5;
			fRec20[0] = fVec7[((IOTA - iConst20) & 4095)];
			...
			float fTemp6 = (fTemp2 + ((0.600000024f * fRec24[1]) + fVec8[((IOTA - iConst24) & 32767)]));
			fVec9[(IOTA & 4095)] = fTemp6;
			fRec24[0] = fVec9[((IOTA - iConst25) & 4095)];
			...
			float fTemp8 = (fVec10[((IOTA - iConst29) & 16383)] - (fTemp7 + (0.600000024f * fRec28[1])));
			fVec11[(IOTA & 2047)] = fTemp8;
			fRec28[0] = fVec11[((IOTA - iConst30) & 2047)];
			...
			float fTemp9 = (fVec12[((IOTA - iConst34) & 16383)] - (fTemp7 + (0.600000024f * fRec32[1])));
			fVec13[(IOTA & 4095)] = fTemp9;
			fRec32[0] = fVec13[((IOTA - iConst35) & 4095)];
			...
			float fTemp10 = ((fTemp7 + fVec14[((IOTA - iConst39) & 16383)]) - (0.600000024f * fRec36[1]));
			fVec15[(IOTA & 4095)] = fTemp10;
			fRec36[0] = fVec15[((IOTA - iConst40) & 4095)];
			...
			float fTemp11 = ((fVec16[((IOTA - iConst44) & 16383)] + fTemp7) - (0.600000024f * fRec40[1]));
			fVec17[(IOTA & 2047)] = fTemp11;
			fRec40[0] = fVec17[((IOTA - iConst45) & 2047)];
